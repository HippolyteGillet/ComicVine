                              ...
                              Container(
                                ...
                                child: TabBarView(
                                  children: [
                                    ...
                                    BlocProvider(
                                      create: (context) =>
                                      CharactersBloc()..add(CharactersRequested(state.movieDetail.charactersUrls)),
                                        ...
                                        children: [
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                ...
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    for (var writer in state.movieDetail.writers)
                                                      Text(
                                                        writer,
                                                        style: TextStyle(
                                                          color: Colors.white,
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                ...
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    for (var producer in state.movieDetail.producers)
                                                      Text(
                                                        producer,
                                                        style: TextStyle(
                                                          color: Colors.white,
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                ...
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    for (var studio in state.movieDetail.studios)
                                                      Text(
                                                        studio,
                                                        style: TextStyle(
                                                          color: Colors.white,
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                width: 175,
                                                child: Text(
                                                  state.movieDetail.budget, ///CONVERTIR
                                                  style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 18,
                                                    fontFamily: GoogleFonts.nunito().fontFamily,
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              SizedBox(
                                                width: 200,
                                                child: Text('Recettes au box-office',
                                                  style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 18,
                                                    fontFamily: GoogleFonts.nunito().fontFamily,
                                              ...
                                              SizedBox(
                                                width: 175,
                                                child: Text(
                                                  state.movieDetail.boxOfficeRevenue, ///CONVERTIR
                                                  style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 18,
                                                    fontFamily: GoogleFonts.nunito().fontFamily,
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              SizedBox(
                                                width: 200,
                                                child: Text('Recettes brutes totales',
                                                  style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 18,
                                                    fontFamily: GoogleFonts.nunito().fontFamily,
                                              ...
                                              SizedBox(
                                                width: 175,
                                                child: Text(
                                                  state.movieDetail.totalRevenue, ///CONVERTIR
                                                  style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 18,
                                                    fontFamily: GoogleFonts.nunito().fontFamily,
